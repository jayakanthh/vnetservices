    ...
    <section ref={containerRef} className="py-32 bg-white relative">
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="absolute left-6 md:left-1/2 top-0 bottom-0 w-px bg-(--vnet-silver-light) md:-translate-x-1/2"></div>
          
          {/* Animated fill line */}
          <motion.div 
            style={{ height: lineHeight }}
            className="absolute left-6 md:left-1/2 top-0 w-px bg-(--vnet-violet) md:-translate-x-1/2 origin-top"
          ></motion.div>
          ...
          <div className="flex flex-col gap-12 md:gap-24 relative">
            {steps.map((step, index) => {
              ...
              return (
                <div key={step.id} className="flex flex-col md:flex-row items-center relative">
                  ...
                  {/* Center Node */}
                  <div className="absolute left-6 md:left-1/2 w-4 h-4 rounded-full bg-white border-2 border-(--vnet-violet) md:-translate-x-1/2 z-10"></div>
                  
                  {/* Mobile & Alt Side Content */}
                  <div className={`ml-16 md:hidden md:w-1/2`}>
